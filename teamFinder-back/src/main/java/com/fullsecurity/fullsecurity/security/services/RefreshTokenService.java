package com.fullsecurity.fullsecurity.security.services;
...
import com.fullsecurity.fullsecurity.repository.RefreshTokenRepository;
...
public class RefreshTokenService {
    @Value("${fullSecurity.app.jwtRefreshExpirationMs}")
